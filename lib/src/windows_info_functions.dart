...
class WindowsSystemInfo {
  ...
  static Future<void> initWindowsInfo({List<WindowsSystemInfoFeat> requiredValues = const [WindowsSystemInfoFeat.all]}) async {
  ...
  static Map<String, dynamic> _getValueFromPowerShell(
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.system)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.bios)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.chassis)) {
      ///system related information
      ///Model
      ///Manufacturer
      ///ChassisTypes
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.os)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.cpu)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.network)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.diskLayout)) {
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.memory)) {
      ///memory layout:
      ///DataWidth
      ///TotalWidth
      ///Capacity
    ...
    if (requiredValues.contains(WindowsSystemInfoFeat.gpu)) {
      ///graphics data
